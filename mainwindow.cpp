...
void MainWindow::getLog()
{
    while(running)
    {
        ...
        QString url = "https://minerooms.com/console/14022";
...
{
    QNetworkAccessManager *manager = new QNetworkAccessManager();
    QString url = "https://minerooms.com/docker/start_server/14022";
    QNetworkRequest request;
    request.setUrl(QUrl(url));
    request.setRawHeader("Cookie","__cfduid=d12e7ff4fe25c0162d956d594642f23601582446396;_ga=GA1.2.500865953.1582446399;_gat=1;_gid=GA1.2.1164300349.1582446399;_mineroom_web_session=%3D--c061a7b38b0c008c3c04bca75b217621993acb48");
...
{
    QNetworkAccessManager *manager = new QNetworkAccessManager();
    QString url = "https://minerooms.com/docker/stop_server/14022";
    QNetworkRequest request;
    request.setUrl(QUrl(url));
    request.setRawHeader("Cookie","__cfduid=d12e7ff4fe25c0162d956d594642f23601582446396;_ga=GA1.2.500865953.1582446399;_gat=1;_gid=GA1.2.1164300349.1582446399;_mineroom_web_session=%3D--c061a7b38b0c008c3c04bca75b217621993acb48");
...
{
    QNetworkAccessManager *manager = new QNetworkAccessManager();
    QString url = "https://minerooms.com/docker/add_hour/14022";
    QNetworkRequest request;
    request.setUrl(QUrl(url));
    request.setRawHeader("Cookie","__cfduid=d12e7ff4fe25c0162d956d594642f23601582446396;_ga=GA1.2.500865953.1582446399;_gat=1;_gid=GA1.2.1164300349.1582446399;_mineroom_web_session=%3D--c061a7b38b0c008c3c04bca75b217621993acb48");
...
void MainWindow::on_pushButton_clicked()
{
    ...
    auto data = "msg="+ui->lineEdit->text().toUtf8().toPercentEncoding()+"&data-action=save_file";
